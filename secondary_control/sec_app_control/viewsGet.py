...
class GetSecondaryClassRoomView(ModelViewSet):
    http_method_names = [ "get" ]
    queryset = SecondaryClassRoom.objects.all().order_by("-academic_year")
    serializer_class = GetSecondaryClassRoomSerializer
...
class GetSecondaryMainSubjectView(ModelViewSet):
    http_method_names = [ "get" ]
    queryset = SecondaryMainSubject.objects.all().order_by("-created_at")
    serializer_class = GetSecondaryMainSubjectSerializer
    parser_classes = (MultiPartParser, FormParser, JSONParser)
    pagination_class = CustomPagination
    filter_backends = (filters.DjangoFilterBackend,)
...
class GetSecondarySubjectView(ModelViewSet):
    http_method_names = [ "get" ]
    queryset = SecondarySubject.objects.all().order_by("-created_at")
    serializer_class = GetSecondarySubjectSerializer
    parser_classes = (MultiPartParser, FormParser, JSONParser)
    pagination_class = CustomPagination
    filter_backends = (filters.DjangoFilterBackend,)
...
class GetSecondaryLevelView(ModelViewSet):
    http_method_names = [ "get" ]
    queryset = SecondaryLevel.objects.all().order_by("-created_at")
    serializer_class = GetSecondaryLevelSerializer
    parser_classes = (MultiPartParser, FormParser, JSONParser)
    pagination_class = CustomPagination
    filter_backends = (filters.DjangoFilterBackend,)
    filterset_class = SecondaryLevelFilter
    # permission_classes = [ IsAuthenticated ]
...
class GetSecondaryResultView(ModelViewSet):
    http_method_names = [ "get" ]
    queryset = SecondaryResult.objects.all().order_by("-created_at")
    serializer_class = GetSecondaryResultSerializer
    parser_classes = (MultiPartParser, FormParser, JSONParser)
    pagination_class = CustomPagination
    filter_backends = (filters.DjangoFilterBackend,)
...
class GetSecondaryResultTranscriptView(ViewSet):
    http_method_names = [ "get" ]
    queryset = SecondaryResult.objects.all().order_by("-created_at")
    serializer_class = GetSecondaryResultSerializer
    filter_backends = (filters.DjangoFilterBackend,)
...
class GetSecondaryResultClassroomView(ViewSet):
    http_method_names = [ "get" ]
    queryset = SecondaryResult.objects.all().order_by("-created_at")
    serializer_class = GetSecondaryResultSerializer
    filter_backends = (filters.DjangoFilterBackend,)
    ...
    def list(self, request):
        ...
        if "student__classroom__id" in param.keys():
            ...
            subjects = SecondarySubject.objects.filter(classroom__id=param["student__classroom__id"])
            subjects_names = subjects.values_list("main_subject__subject_name", flat=True)
            profs = SecondaryProfile.objects.filter(classroom__id=param["student__classroom__id"])
        results = []
        for p in profs:
            my_res = []
...
class GetSecondaryPublishView(ModelViewSet):
    http_method_names = [ "get" ]
    queryset = SecondaryPublish.objects.all().order_by("-created_at")
    serializer_class = GetSecondaryPublishSerializer
    parser_classes = (MultiPartParser, FormParser, JSONParser)
    pagination_class = CustomPagination
    filter_backends = (filters.DjangoFilterBackend,)
...
class GetSecondaryMyClassRoomsView(ViewSet):
    # permission_classes = [ IsAuthenticated ]
...
class GetSecondaryAcademicYearView(ViewSet):
    # permission_classes = [ IsAuthenticated ]
