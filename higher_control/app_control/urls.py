...
router.register('get-school-info-higher',  GetSchoolInfoView, "get-school-info-higher" ),
router.register('get-school-identification-higher',  GetSchoolIdentificationView, "get-school-identification-higher" ),
