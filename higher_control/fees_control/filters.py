...
class SchoolFeesFilter(django_filters.FilterSet):
    ...
    userprofile__specialty__tuition = django_filters.CharFilter(lookup_expr="iexact")
    userprofile__specialty__registration = django_filters.CharFilter(lookup_expr="iexact")
...
class TransactionsFilter(django_filters.FilterSet):
    ...
    schoolfees__userprofile__specialty__registration = django_filters.CharFilter(lookup_expr="exact")
