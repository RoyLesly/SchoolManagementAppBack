...
class Setting(CreatedUpdatedModel):
    ...
    latitude = models.DecimalField(max_digits=9, decimal_places=7, blank=False, default=3.8436864)
    longitude = models.DecimalField(max_digits=9, decimal_places=7, blank=False, default=11.4917376)
